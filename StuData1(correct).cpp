...
main ()
{
  ...
  while (flag == 1)
	...
	case 3:
	  cout << "Enter the Roll number of student to updates the details: "
	    << endl;
	  cin >> modify;
	  flags = 1;
	  while (flags == 1)
		  ...
		  if (r == modify)
		    {
		      ...
		      cout << "4:Change the Driving license of the student "
			<< endl;
		      cout << "5:Change the Phone number of the student " <<
			endl;
		      cout << "6: Exit" << endl;
		      cout << "ENTER YOUR CHOICE :" << endl;
		      cin >> option;
			...
			default:
			  cout <<
			    "Incorrect choice Please enter the appropiate choice ";
			}
		    }
		}
	    }
